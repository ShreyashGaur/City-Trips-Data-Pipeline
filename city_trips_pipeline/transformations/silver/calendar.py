...
@dp.materialized_view(
    name="city_trips_data.silver.calendar",
    comment="Calendar dimension with comprehensive data attributes and Indian holidays (2020 - 2030)",
    table_properties={
        "quality": "city_trips_data.silver.calendar",
        "layer": "silver",
...
def calendar():
    ...
    df = (
        ...
        .withColumn(
            "quarter_year",
            F.concat(F.lit("Q"), F.quarter(F.col("date")), F.lit(" "), F.col("year")),
        )
        .withColumn(
