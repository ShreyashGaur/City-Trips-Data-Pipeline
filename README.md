...
# Unzip the file
# You will get Two folders: "dataset" and "city_trips_pipeline" and two files: "Catalog and Schemas" and "Guide"
# Follow the guide or github readme file to execute the project step-by-step
-------------------------------------------------------------------------
